...
const Sidebar = () => {
  ...
  return (
    <aside className="w-[240px] relative block h-full z-[100] pt-[70px] pb-[54px] side-bar ">
      <nav className="fixed w-[240px] h-[70px] top-0 pt-0 pb-0  pl-[28px] pr-[25px] flex items-center bg-[#241b31] opacity-[0.97]">
        <Link to={"/"}>
          <img
      ...
      <div
        className={`block ${
          currentSongID !== null ? "heiht" : "height-detail"
        }`}
      >
        <nav className="relative mb-4 w-full  ">
          <ul className="nav">
            <li className="zm-navbar-item">
              <NavLink className={activeMenu} to={"/"} title="khám phá">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li className="zm-navbar-item">
              <NavLink className={activeMenu} to={"/radio"} title="radio">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li className="zm-navbar-item">
              <NavLink className={activeMenu} to={"/mymusic"} title="mymusic">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
        ...
        <div
          className={`relative overflow-x-hidden  w-full  bg-[#170f23] ${
            currentSongID !== null ? "heiht-item" : "heiht-item-detail"
          }
        `}
        >
          <div
            className={`zm-nav-scroll ${
              currentSongID !== null ? "heiht-item" : "h-full"
            }`}
          >
            <nav className="relative mb-4 w-full">
              <ul className="nav">
                ...
                <li className="zm-navbar-item">
                  <NavLink className={activeMenu} to={"/hub"} title="khám phá">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <div>
              <div>
                <a href="#" className="block w-[200px] my-4 mx-auto">
                  <img src={"./img/zm-sidebar.png"} alt="" />
                </a>
              </div>
            </div>
            ...
            {/* zm-navbar-my-music */}
            {isAuthenticated && (
              <nav className="w-full text-[12px] pt-4 mb-4">
                <ul>
                  <li className="zm-navbar-item">
                    <NavLink
                      className={activeMenu}
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          fill="url(#paint0_linear_2645_12881)"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                  ...
                  <li className="zm-navbar-item">
                    <a className="" href="#" title="khám phá">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                          d="M0.5164 7.14319C1.32829 3.21545 3.8263 1.02782 7.72282 0.366909C10.6032 -0.121503 13.4847 -0.12767 16.3602 0.380652C20.3723 1.08984 22.7841 3.40504 23.5524 7.39215C24.1461 10.4736 24.1554 13.5879 23.5431 16.6663C22.7218 20.5669 20.1593 22.9747 16.2772 23.6331C13.3968 24.1215 10.5153 24.1277 7.63977 23.6193C3.62772 22.9102 1.20521 20.4794 0.436861 16.4923C-0.186982 13.3905 -0.126933 10.2566 0.5164 7.14319Z"
                          fill="url(#paint0_linear_2645_12880)"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                    ...
                    <a className="" href="#" title="khám phá">
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                          d="M0.5164 7.14319C1.32829 3.21545 3.8263 1.02782 7.72282 0.366909C10.6032 -0.121503 13.4847 -0.12767 16.3602 0.380652C20.3723 1.08984 22.7841 3.40504 23.5524 7.39215C24.1461 10.4736 24.1554 13.5879 23.5431 16.6663C22.7218 20.5669 20.1593 22.9747 16.2772 23.6331C13.3968 24.1215 10.5153 24.1277 7.63977 23.6193C3.62772 22.9102 1.20521 20.4794 0.436861 16.4923C-0.186982 13.3905 -0.126933 10.2566 0.5164 7.14319Z"
                          fill="url(#paint0_linear_3153_2362)"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                    ...
                    <a className="" href="#" title="khám phá">
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                          d="M0.5164 7.14319C1.32829 3.21545 3.8263 1.02782 7.72282 0.366909C10.6032 -0.121503 13.4847 -0.12767 16.3602 0.380652C20.3723 1.08984 22.7841 3.40504 23.5524 7.39215C24.1461 10.4736 24.1554 13.5879 23.5431 16.6663C22.7218 20.5669 20.1593 22.9747 16.2772 23.6331C13.3968 24.1215 10.5153 24.1277 7.63977 23.6193C3.62772 22.9102 1.20521 20.4794 0.436861 16.4923C-0.186982 13.3905 -0.126933 10.2566 0.5164 7.14319Z"
                          fill="url(#paint0_linear_2645_12883)"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
